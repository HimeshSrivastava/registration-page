...
<div className="flex flex-col-reverse md:flex-row h-full w-full md:w-[900px] md:h-[400px] gap-16 items-start m-auto border-s-violet-950 bg-white">
<div className="flex flex-col w-1/2 h-1/2 gap-3 p-5">
<h1 className="font-bold text-2xl text-blue-900 ">Login to your account</h1>
